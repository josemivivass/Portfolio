...
const ES: Record<string, string> = {
  ...
  'projects.notebook.open': 'Abrir notebook',
  'projects.notebook.view': 'Ver notebook',
  'projects.notebook.colab': 'Abrir en Colab',
  'projects.notebook.loading': 'Cargando notebook…',
  'projects.notebook.error': 'No se pudo cargar el notebook.',
  ...
  // --- Contact ---
  'contact.title': 'Conversa<em>mos</em>.',
  'contact.subtitle': '¿Tienes un proyecto en mente? Hablemos.',
  'contact.chapter': 'Capítulo',
  'contact.lead': 'Cuéntame en qué estás trabajando. <em>Respondo en menos de 24 horas</em>.',
  'contact.placeholder.name': 'Tu nombre completo',
  'contact.placeholder.email': 'tu@correo.com',
  'contact.placeholder.message': 'Cuéntame brevemente sobre tu proyecto, el plazo y lo que necesitas. Cuanto más concreto, mejor.',
  'contact.meta.pd': 'P.D.',
  'contact.meta.min': 'Mínimo veinte caracteres',
  'contact.aside.label': '— Líneas directas',
  'contact.line.email': 'Correo',
  'contact.line.phone': 'Teléfono',
  'contact.signature': '— Atentamente, <em>JMVS</em>.',
  ...
  'login.submit': 'Entrar al portfolio',
  'login.loading': 'Verificando...',
  'login.no.account': '¿Aún no tienes <strong>cuenta</strong>?',
  'login.create': 'Crear cuenta',
  'login.show.password': 'Mostrar contraseña',
  'login.hide.password': 'Ocultar contraseña',
  'login.show.password.short': 'Mostrar',
  'login.hide.password.short': 'Ocultar',
  ...
  'register.title': 'Crea tu <em>cuenta</em>.',
  ...
  'register.has.account': '¿Ya tienes <strong>cuenta</strong>?',
  ...
  'admin.profile.cv.select': 'PDF',
  'admin.profile.cv.change': 'PDF',
  ...
  'admin.profile.backup.files.button': 'Backup de archivos (.zip)',
  'admin.profile.backup.files.loading': 'Empaquetando…',
  'admin.profile.backup.files.saved': 'Archivos descargados',
  'admin.profile.backup.files.error': 'No se pudo generar el zip',
  ...
  'admin.notebook.new': '+ Nuevo notebook',
  'admin.notebook.create.title': 'Crear notebook',
  'admin.notebook.edit.title': 'Editar notebook',
  'admin.notebook.link.title': 'Archivo del notebook (.ipynb)',
  'admin.notebook.link.sub': 'Pega el enlace de GitHub del archivo .ipynb concreto (la vista del archivo en github.com).',
  'admin.notebook.link.ok': 'Detectado:',
  'admin.notebook.link.invalid': 'El enlace no es un archivo .ipynb de GitHub válido.',
  ...
  'admin.visitors.col.country': 'País',
  'admin.visitors.col.city': 'Ciudad',
  'admin.visitors.col.browser': 'Navegador',
  'admin.visitors.col.logged': 'Logueado',
  'admin.visitors.empty': 'No hay visitas registradas.',
  'admin.visitors.map.title': 'Mapa de visitas',
  'admin.visitors.map.sub': '{c} países · {city} ciudades',
  'admin.visitors.map.show.cities': 'Mostrar ciudades',
  'admin.visitors.map.top.countries': 'Top países',
  'admin.visitors.map.unknown': 'Desconocido',
  'admin.visitors.map.visits': 'visitas',
  'admin.visitors.map.empty': 'Sin datos de geolocalización todavía.',
  'admin.visitors.map.legend.countries': 'Países',
  'admin.visitors.map.legend.cities': 'Ciudades',
...
const EN: Record<string, string> = {
  ...
  'projects.notebook.open': 'Open notebook',
  'projects.notebook.view': 'View notebook',
  'projects.notebook.colab': 'Open in Colab',
  'projects.notebook.loading': 'Loading notebook…',
  'projects.notebook.error': 'Could not load the notebook.',
  ...
  'contact.chapter': 'Chapter',
  'contact.lead': 'Tell me what you\'re working on. <em>I reply in under 24 hours</em>.',
  'contact.placeholder.name': 'Your full name',
  'contact.placeholder.email': 'your@email.com',
  'contact.placeholder.message': 'Tell me briefly about your project, the timeline and what you need. The more specific, the better.',
  'contact.meta.pd': 'P.S.',
  'contact.meta.min': 'Minimum twenty characters',
  'contact.aside.label': '— Direct lines',
  'contact.line.email': 'Email',
  'contact.line.phone': 'Phone',
  'contact.signature': '— Yours, <em>JMVS</em>.',
  ...
  'login.submit': 'Enter portfolio',
  'login.loading': 'Verifying...',
  'login.no.account': 'Don\'t have an <strong>account</strong> yet?',
  'login.create': 'Create account',
  'login.show.password': 'Show password',
  'login.hide.password': 'Hide password',
  'login.show.password.short': 'Show',
  'login.hide.password.short': 'Hide',
  ...
  'register.title': 'Create your <em>account</em>.',
  ...
  'register.has.account': 'Already have an <strong>account</strong>?',
  ...
  'admin.profile.backup.files.button': 'Files backup (.zip)',
  'admin.profile.backup.files.loading': 'Packaging…',
  'admin.profile.backup.files.saved': 'Files downloaded',
  'admin.profile.backup.files.error': 'Could not generate the zip',
  ...
  'admin.notebook.new': '+ New notebook',
  'admin.notebook.create.title': 'Create notebook',
  'admin.notebook.edit.title': 'Edit notebook',
  'admin.notebook.link.title': 'Notebook file (.ipynb)',
  'admin.notebook.link.sub': 'Paste the GitHub link of the specific .ipynb file (the file view on github.com).',
  'admin.notebook.link.ok': 'Detected:',
  'admin.notebook.link.invalid': 'The link is not a valid GitHub .ipynb file.',
  ...
  'admin.visitors.col.uuid': 'UUID',
  'admin.visitors.col.ip': 'IP',
  'admin.visitors.col.country': 'Country',
  'admin.visitors.col.city': 'City',
  'admin.visitors.col.browser': 'Browser',
  'admin.visitors.col.logged': 'Logged in',
  'admin.visitors.empty': 'No visits recorded.',
  'admin.visitors.map.title': 'Visits map',
  'admin.visitors.map.sub': '{c} countries · {city} cities',
  'admin.visitors.map.show.cities': 'Show cities',
  'admin.visitors.map.top.countries': 'Top countries',
  'admin.visitors.map.unknown': 'Unknown',
  'admin.visitors.map.visits': 'visits',
  'admin.visitors.map.empty': 'No geolocation data yet.',
  'admin.visitors.map.legend.countries': 'Countries',
  'admin.visitors.map.legend.cities': 'Cities',
